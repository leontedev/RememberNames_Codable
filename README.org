...
Project 12a - Day 49 - [[https://www.hackingwithswift.com/100]]

*Added Persistance to Project 10 using UserDefaults and Codable (JSON). Remember Names is an app to import photos of people (from the photo library or capture with the camera) & put a name to the face to help you learn it.*
...
[[day44.png]]
** Day 49 - Codable
Added data persistance using Codable and UserDefau;ts
